...
That's the goal of this manifesto: to create a specification for an open standard for synchronizing feeds, a simple API that let's a client request and update subscriptions and items from a remote server.